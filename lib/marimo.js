...
marimo.widgetlib.base_widget = {
    ...
    on: function(evnt, cb, context) {
        ...
        wrapped_cb = function(){cb.apply(context,Array.prototype.slice.call(arguments))};
        if (typeof evnt === 'object' && typeof evnt.length !== 'undefined') {
            this.onlist.call(context, evnt, wrapped_cb);
            return;
        }
    ...
    onlist: function(evntlist, cb) {
        if (evntlist.length > 0) {
            ...
            var that = this;
            this.on(evnt, function() { this.onlist(evntlist, cb);}, this);
        }
        else {
            cb();
        };
