...
var marimo = {
    ...
    // diffherit from something, return new object
...
marimo.widgetlib.base_widget = {
    ...
    emit: function(evnt) {
        // convenience wrapper for symmetry; later will probably be part of
...
marimo.widgetlib.request_widget = marimo.extend(marimo.widgetlib.base_widget, {
    ...
    add_request: function () {
        // Submit a request to the request queue to be bulked and dispatched
    ...
    make_request: function () {
        // Immediately make a request for new data
        marimo.$.ajax({
            url: this.murl,
            type: 'GET',
    ...
    transform: function (data) {
        // optionally mutate data. this will be called before any invocation of
        // update. Override in clones.
        return data;
    },
    update: function (data) {
